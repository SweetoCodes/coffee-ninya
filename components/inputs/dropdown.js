...
export default function DropDown({
  ...
  return (
    <div className={"input-container" + style}>
      ...
      {expanded && (
        <div className="absolute flex flex-col cursor-pointer py-1 z-10 overflow-y-auto max-h-[300px] sm:w-[200px] w-full text-base bg-white rounded divide-y divide-gray-100 shadow" aria-labelledby="dropdownButton">
